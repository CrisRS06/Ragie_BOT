...
/**
 * Admin - Crear Nueva Unidad Receptora
 */
...
export default function NuevaUnidadReceptoraPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        throw new Error(data.error || 'Error al crear unidad receptora');
      }

      router.push('/admin/unidades-receptoras');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Error al crear unidad receptora');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Nueva Unidad Receptora</h1>
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Complete la información de la nueva unidad receptora
          </p>
        </div>
